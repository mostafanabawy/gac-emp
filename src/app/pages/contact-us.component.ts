...
export class ContactUsComponent {
  ...
  contactList = [
    {
      userId: 1,
      name: 'استفسار عن برامج الشباب الصيفية',
      path: 'profile-16.jpeg',
      time: 'اليوم، 10:05 صباحا',
      preview: 'معلومات حول برامج الشباب الصيفية المتاحة هذا العام وشروط التسجيل...',
      messages: [
        {
          fromUserId: 0,
          toUserId: 1,
  ...
  detectDirection(text: string): 'rtl' | 'ltr' {
