...
import { HistoryClockComponent } from './history-clock';
import { IconStarsComponent } from './icon-stars';
import { QuestionCircleComponent } from './question-circle';
import { RedoComponent } from './icon-redo';
import { UndoComponent } from './icon-undo';
