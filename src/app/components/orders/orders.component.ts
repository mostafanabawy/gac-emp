...
constructor() {}
    search = '';
    cols = [
      { field: 'id', title: '#', isUnique: true, hide: false },
      { field: 'firstName', title: 'رقم الطلب', hide: false },
      { field: 'lastName', title: 'رقم الرخصة', hide: false },
      { field: 'email', title: 'التاريخ', hide: false },
      { field: 'phone', title: 'النشاط', hide: false },
      { field: 'company', title: 'النوع', hide: false },
      { field: 'address.street', title: 'حالة الطلب', hide: false },
      { field: 'age', title: 'نوع الاجراء', hide: false },
  ];
