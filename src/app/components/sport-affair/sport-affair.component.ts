...
@Component({
  imports: [CommonModule, FlatpickrModule, QuillModule],
  standalone: true,
  selector: 'app-sport-affair',
  templateUrl: './sport-affair.component.html',
  styleUrls: ['./sport-affair.component.css'],
})
export class SportAffairComponent implements AfterViewInit {
  activeTab: number = 1;
